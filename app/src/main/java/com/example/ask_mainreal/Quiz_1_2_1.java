...
public class Quiz_1_2_1 extends AppCompatActivity {
    // declaring UI elements shared preferences and a string to temporarily store user input
    Button home;
    Button a;
    Button b;
    Button c;
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Set up the click listener for button n
